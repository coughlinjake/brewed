...
module Brewed
  module Extract
    ...
    ##
    def extract_list(str, pat, *matchvars)
      rc = []
    ...
    ##
    def extract_string(str, pat, matchvar)
      (self.extract_list str, pat, matchvar).first || ''
    end
    ...
    ##
    def extract_integer(str, pat, matchvar)
      ((self.extract_list str, pat, matchvar).first || 0).to_i
    end
